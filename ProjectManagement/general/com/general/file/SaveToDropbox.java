...
public class SaveToDropbox {
    ...
    private static void uploadFile(DbxClientV2 dbxClient, File localFile, String dropboxPath) {
        try (InputStream in = new FileInputStream(localFile)) {
            ...
            System.out.println(dbxClient.sharing().getSharedLinks());
    ...
    /*public static void main(String[] args) throws IOException {
        ...
        Logger.getLogger("").setLevel(Level.WARNING);
         ...
         String[] data= {"/home/janhavee/Effexway/PropelPM/propel/general/com/general/file/Janhavee.app", "/home/janhavee/Downloads/productlist.csv", "/Dropbox/T"};
         
         saveFile(data);
        
    }*/
    
    public static boolean saveFile(String[] args) {
    	if (args.length != 3) {
            System.out.println("");
