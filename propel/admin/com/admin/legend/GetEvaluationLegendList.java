 ...
 */
@WebServlet("/GetEvaluationLegendList")
public class GetEvaluationLegendList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    */
	    String sql = "SELECT * FROM propel_legend.evaluationlegendlist where 1=1 ";
