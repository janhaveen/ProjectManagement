    ...
    <div class="modal-dialog modal-notify modal-danger" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" style="background:#cc4141;">
                <h6 class="heading" style="color: white;">Delete Project</h6>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <br>
                        <p>Project details will be deleted from system.</p>
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" class="btn btn-danger-modal" id="DeleteEmployeeConfirmed" style="background:#cc4141;color: white">Confirm</a>
                <a type="button" class="btn btn-outline-danger-modal waves-effect" data-dismiss="modal">Close</a>
            </div>
        </div>
        <!--/.Content-->
    </div>
