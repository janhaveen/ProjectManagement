    ...
    <div class="modal-dialog modal-notify modal-danger" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" style="background:#cc4141;">
                <p class="heading" style="color:white;">Delete Solution Matrix</p>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <br>
                        <p id="wInfo">Solution Matrix details will be deleted from system.</p>
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" class="btn btn-danger-modal whiteText" id="DeleteConfirmed" style="background:#cc4141;">Confirm</a>
