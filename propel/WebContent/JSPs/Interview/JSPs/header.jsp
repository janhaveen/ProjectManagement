<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link rel="stylesheet" href="http://localhost:8081/Project_Management/Styles/css/bootstrap.min.css">
        <!-- Material Design Bootstrap -->
        <link rel="stylesheet" href="http://localhost:8081/Project_Management/Styles/css/mdb.min.css">
        <link rel="stylesheet" href="http://localhost:8081/Project_Management/Scripts/vendor/datatables/css/buttons.dataTables.min.css">
		<link rel="stylesheet" href="http://localhost:8081/Project_Management/Scripts/vendor/datatables/css/dataTables.bootstrap4.min.css">
    ...
    <body class="fixed-sn white-skin">
		...
		<script src="http://localhost:8081/Project_Management/JavaScripts/General/IDGenerator.js"></script>
        <script src="http://localhost:8081/Project_Management/Scripts/js/jquery-3.2.1.min.js"></script>
        <!-- Bootstrap tooltips -->
        <script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/js/popper.min.js"></script>
        <!-- Bootstrap core JavaScript -->
        <script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/js/bootstrap.js"></script>
        <!-- MDB core JavaScript -->
        <script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/js/mdb.min.js"></script>
        <!--Custom scripts-->
		<script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/vendor/datatables/js/jquery.dataTables.min.js"></script>
		<script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
		<script type="text/javascript" src="http://localhost:8081/Project_Management/Scripts/vendor/datatables/js/dataTables.buttons.min.js"></script>
    </body>
    <script>
